...
void PARAMS_InitManual(PARAMS_t* params_ptr)
{
    ...
    params_ptr->filt.spd_ar_wz[0] = HZ_TO_RADSEC(MOTOR_CTRL_SPEED_AR_FILTER_WZ0); // [Ra/sec]
    params_ptr->filt.spd_ar_wz[1] = HZ_TO_RADSEC(MOTOR_CTRL_SPEED_AR_FILTER_WZ1); // [Ra/sec]
...
void PARAMS_InitManual_M1(PARAMS_t* params_ptr)
{
    ...
    params_ptr->filt.spd_ar_wp[0] = HZ_TO_RADSEC(75.0f); // [Ra/sec]
    params_ptr->filt.spd_ar_wp[1] = HZ_TO_RADSEC(75.0f); // [Ra/sec]
    params_ptr->filt.spd_ar_wz[0] = HZ_TO_RADSEC(MOTOR_CTRL_SPEED_AR_FILTER_WZ0_M1); // [Ra/sec]
    params_ptr->filt.spd_ar_wz[1] = HZ_TO_RADSEC(MOTOR_CTRL_SPEED_AR_FILTER_WZ1_M1); // [Ra/sec]
    params_ptr->filt.acc_w0 = HZ_TO_RADSEC(1.0f); // [Ra/sec]
