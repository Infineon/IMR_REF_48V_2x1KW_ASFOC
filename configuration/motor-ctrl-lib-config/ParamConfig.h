...
#define ADC_CS_SHUNT_RES                         (20.0E-3f)                    /*[Ohm], Applicable for Current shunt type of measurement*/
...
#define ADC_SCALE_VUVW                           ((7.87f)/(162.0f+7.87f))      /*[V/V] = [Ohm/Ohm]*/
#define ADC_SCALE_VDC                            ((7.87f)/(162.0f+7.87f))      /*[V/V] = [Ohm/Ohm]*/
/*******************************************************************************/
/*******************************************************************************/
/*Parameter Controls*/
/***MCU***/
...
#if (SWITCHING_DEVICE_TYPE == SI_MOSFET)
#define MOTOR_CTRL_FASTLOOP_FREQ                   (20000.0f)                  /*[Hz], fast-loop frequency at least 1.2 decade above maximum electrical frequency, 1.5kHz~>25kHz*/
#elif (SWITCHING_DEVICE_TYPE == GAN_FET)
...
#define MOTOR_CTRL_FASTLOOP_FREQ                   (20000.0f)                  /*[Hz], fast-loop frequency at least 1.2 decade above maximum electrical frequency, 1.5kHz~>25kHz*/
#endif
#define MOTOR_CTRL_FS0_FS1_RATIO                   (20U)                       /*[], Fast-loop to slow-loop frequency ratio*/
...
#define MOTOR_CTRL_COMMAND_MAX_SPEED               (MOTOR_MAX_SPEED)            /*[RPM], maximum speed command*/ //MOTOR_NORM_SPEED
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
#define MOTOR_CTRL_COMMAND_MAX_CURRENT             (MOTOR_CURRENT_PEAK*0.5f)    /*[A], maximum current command*/ //MOTOR_CURRENT_CONT
#elif defined(CTRL_METHOD_SFO)
...
#define MOTOR_CTRL_SPEED_AR_FILTER_WZ0			   (INFINITY)					 /* Default: INFINITY*/ //(1500.0f)
#define MOTOR_CTRL_SPEED_AR_FILTER_WZ1			   (INFINITY)					 /* Default: INFINITY*/ //(1500.0f)
/*******************************************************************************/
/*******Control*******/
...
#if OFFSET_CAL_DONE
#define MOTOR_CTRL_CTRL_MODE                       (Speed_Mode_FOC_Encoder_Align_Startup)/*Control mode*/
#else
...
#ifdef USING_TLI_5012B
#if OFFSET_CAL_DONE
#define MOTOR_CTRL_SPEED_BW                        (180.0f)                     /*[Hz], Speed loop bandwidth*/
#else
#define MOTOR_CTRL_SPEED_BW                        (20.0f)                      /*[Hz], Speed loop bandwidth*/ //max. 50.0f for sensorless FOC
#endif
#else
#define MOTOR_CTRL_SPEED_BW                        (20.0f)                      /*[Hz], Speed loop bandwidth*/ //Default 15.0f to 20.0f
#endif
//------------------------------------------------------------------------
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW                      (1000.0f)                      /*[Hz], Current loop bandwidth*/ //Default 500.0f but 1000.0f found to be better for low current application
...
/*********Voltage Controller*********/
#define MOTOR_CTRL_VOLT_STARTUP_THRESH             (MOTOR_NORM_SPEED*0.01f)      /*[RPM], startup threshold*/
#define MOTOR_CTRL_VOLT_VF_OFFSET                  (0.8f)                        /*[V], V/F ramp voltage offset*/ //(0.15f)
#define MOTOR_CTRL_VOLT_VF_RATIO                   (1.5E-2f)                     /*[V/(Rad/secz], V/f ramp slope*/ //(7.5E-3f)
...
/*******Motor*******/
#if (MOTOR_TYPE == GL60_KV25)
#define MOTOR_POLE                                 (28.0f)                      /*[],  motor poles*/  //24N28P
...
#elif (MOTOR_TYPE == GM7008L_KV26)
#define MOTOR_POLE                                 (22.0f)                      /*[],  motor poles*/ //24N22P
...
#define ADC_CS_SHUNT_TYPE_M1                        (Three_Shunt)                /*Three_Shunt =0, Single_Shunt =1*/

#define ADC_CS_SHUNT_RES_M1                         (20.0E-3f)                  /*[Ohm], Applicable for Current shunt type of measurement*/
...
#define ADC_SCALE_VUVW_M1                           ((7.87f)/(162.0f+7.87f))    /*[V/V] = [Ohm/Ohm]*/
#define ADC_SCALE_VDC_M1                            ((7.87f)/(162.0f+7.87f))    /*[V/V] = [Ohm/Ohm]*/
/*******************************************************************************/
...
#define MOTOR_CTRL_COMMAND_MAX_SPEED_M1              (MOTOR_MAX_SPEED_M1)          /*[RPM], maximum speed command*/
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
#define MOTOR_CTRL_COMMAND_MAX_CURRENT_M1            (MOTOR_CURRENT_PEAK_M1*0.5f)   /*[A], maximum current command*/
#elif defined(CTRL_METHOD_SFO)
...
/*********Incremental Encoder*********/
#define MOTOR_CTRL_ENCODER_CPR_M1                    (500U * 4U)                    /*[], Edges per revolution*/ //16384U
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW_M1                     (1000.0f)                      /*[Hz], Current loop bandwidth*/ //Default 500.0f but 1000.0f found to be better for low current application
...
#define MOTOR_CTRL_VOLT_VF_OFFSET_M1                 (0.8f)                       /*[V], V/F ramp voltage offset*/
#define MOTOR_CTRL_VOLT_VF_RATIO_M1                  (1.5E-2f)                    /*[V/(Rad/secz], V/f ramp slope*/
