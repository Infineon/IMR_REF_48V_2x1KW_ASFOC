...
static void* const ADC_Result_Regs_MUXA[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(ADC_SAMP_IU_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IW_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_RESULT_ADDR(ADC_SAMP_VPOT_CHAN_IDX)},
         {ADC_RESULT_ADDR(ADC_SAMP_IV_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED}};
...
static void* const ADC_Result_Regs_MUXB[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(ADC_SAMP_IU_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_CHAN_IDX), ADC_SAMP_UNUSED,  ADC_SAMP_UNUSED, ADC_RESULT_ADDR(ADC_SAMP_VPOT_CHAN_IDX)},
         {ADC_RESULT_ADDR(ADC_SAMP_IU_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED}};
...
static void* const ADC_Result_Regs_MUXA_M1[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
		  {{ADC_RESULT_ADDR(ADC_SAMP_IU_M1_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IW_M1_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_RESULT_ADDR(ADC_SAMP_VPOT_M1_CHAN_IDX)},
		   {ADC_RESULT_ADDR(ADC_SAMP_IV_M1_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_M1_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED}};
...
static void* const ADC_Result_Regs_MUXB_M1[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(ADC_SAMP_IU_M1_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_M1_CHAN_IDX), ADC_SAMP_UNUSED,  ADC_SAMP_UNUSED, ADC_RESULT_ADDR(ADC_SAMP_VPOT_M1_CHAN_IDX)},
         {ADC_RESULT_ADDR(ADC_SAMP_IU_M1_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED, ADC_SAMP_UNUSED}};
...
void MCU_RoutingConfigMUXA_M1()
{
    ...
    {
    	 .dirSampMsk = 0x280U,/*1<<ADC_SAMP_VBUS_M1_CHAN_IDX, */
    	 .muxSampMsk = 0x0U,
	     .muxChanIdx = {0U,0U,0U,0U},
