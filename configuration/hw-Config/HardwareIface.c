...
#if (MOTOR_CTRL_MOTOR1_ENABLED)
	  // add delay to have 180deg shift between motor_0 and motor_1
	  delay_180deg = (uint16_t)(1000000.0 / (MOTOR_CTRL_FASTLOOP_FREQ * 2.0));
      Cy_SysLib_DelayUs(delay_180deg); // control loop period / 2.0
