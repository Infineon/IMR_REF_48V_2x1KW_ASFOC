...
volatile edl7141_register_t Edl7141Reg1 =
{
	...
	.CSAMP_CFG2 =
	OCP_POS_THR_150mV << CSAMP_CFG2_CS_OCP_PTHR_Pos | //OCP_POS_THR_300mV << CSAMP_CFG2_CS_OCP_PTHR_Pos |
	OCP_NEG_THR_150mV << CSAMP_CFG2_CS_OCP_NTHR_Pos | //OCP_NEG_THR_300mV << CSAMP_CFG2_CS_OCP_NTHR_Pos |
	OCP_FLT_LATCH_EN << CSAMP_CFG2_CS_OCP_LATCH_Pos | //OCP_FLT_LATCH_DIS << CSAMP_CFG2_CS_OCP_LATCH_Pos |
...
void EDL7141_MOTOR_PARAM_set_default(edl7141_register_t *prm)
{
	...
	prm->IDRIVE_CFG =
	IDRIVE_20mA << IDRIVE_CFG_IHS_SRC_Pos |		// IDRIVE_500mA << IDRIVE_CFG_IHS_SRC_Pos |
	IDRIVE_20mA << IDRIVE_CFG_IHS_SINK_Pos |	// IDRIVE_500mA << IDRIVE_CFG_IHS_SINK_Pos |
	IDRIVE_20mA << IDRIVE_CFG_ILS_SRC_Pos |		// IDRIVE_500mA << IDRIVE_CFG_ILS_SRC_Pos |
	IDRIVE_20mA << IDRIVE_CFG_ILS_SINK_Pos;		// IDRIVE_500mA << IDRIVE_CFG_ILS_SINK_Pos;
	...
	#elif (SWITCHING_DEVICE_TYPE == GAN_FET)
	prm->TDRIVE_SRC_CFG =
	TDRIVE1_0ns << TDRIVE_SRC_CFG_TDRIVE1_Pos |
	TDRIVE2_100ns << TDRIVE_SRC_CFG_TDRIVE2_Pos;

	prm->TDRIVE_SINK_CFG =
	TDRIVE3_0ns << TDRIVE_SINK_CFG_TDRIVE3_Pos |
	TDRIVE4_100ns << TDRIVE_SINK_CFG_TDRIVE4_Pos;
