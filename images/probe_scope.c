...
#define  PROBE_SCOPE_CH9                       9
#define  PROBE_SCOPE_CH10                      10
...
#if PROBE_SCOPE_MAX_CH >= 9
static    PROBE_SCOPE_CH       ProbeScope_Ch9;
#endif

#if PROBE_SCOPE_MAX_CH >= 10
static    PROBE_SCOPE_CH       ProbeScope_Ch10;
#endif
...
#if PROBE_SCOPE_MAX_CH >= 9                     
    ProbeScope_SampleCh(&ProbeScope_Ch9);
#endif

#if PROBE_SCOPE_MAX_CH >= 10                     
    ProbeScope_SampleCh(&ProbeScope_Ch10);
#endif                     
}
...
#if PROBE_SCOPE_MAX_CH >= 9
        case PROBE_SCOPE_CH9:
             p_ch = &ProbeScope_Ch9;
             break;
#endif

#if PROBE_SCOPE_MAX_CH >= 10
        case PROBE_SCOPE_CH10:
             p_ch = &ProbeScope_Ch10;
             break;
#endif
